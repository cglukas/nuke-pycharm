...
class Node(object):
    ...
    def setCustomIcon(self, image, scale, offsetX, offsetY):
...
class ProgressTask(object):
    ...
    def __init__(self, title):
        """
        Args:
            title: title of the new progress task
        """
...
class Root(Group):
    ...
    def getOCIOColorspaceFromViewTransform(self, display, view):
...
class SceneGraph_Knob(Unsigned_Knob):
    ...
    def removeItems(self, [name1, name2, ...]):
    ...
    def setSelectedItems(self, [name1, name2, ...]):
...
def addDefaultColorspaceMapper():
    """
...
def removeDefaultColorspaceMapper():
    """
    Remove a previously-added callback with the same arguments.
    """
    pass
